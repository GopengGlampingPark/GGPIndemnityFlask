...
SPREADSHEET_ID = '18v8ytVft-nH7n3rLsTliyBHR0fM0HxdIxQj7HlgrZE4'
...
def genbookid():
	if request.method == "POST":
		C_bookingID = generate_sequential_id("GGPBOOKID_")
...
def submit_form(C_UniqueID):
	...
	activity_mapping = {
		"WWR": "Whitewater Rafting",
		"FTR": "Funtrip Rafting",
		"PB": "Paintball",
		"ATV": "ATV",
		"WA": "Waterfall Abseiling",
		"SH": "Sunset Hiking",
		"CE": "Cave Exploration",
		"TB": "Team Building / Telematch",
		"EXP": "Explorace",
		"NONE": "None"
	}
